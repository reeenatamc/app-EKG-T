 ...
 */
export function ReviewScreen({ photo, onDiscard, onConfirm }: ReviewScreenProps) {
 ...
 *
 * Continuar se deshabilita solo cuando las esquinas se han cruzado, porque en
 * ese caso no existe un recorte que enviar. Es la unica situacion de todo el
 * modulo en la que se impide avanzar, y no es un juicio sobre la calidad de la
 * foto sino una imposibilidad geometrica.
 */
function ReviewActions({ canContinue, onDiscard, onConfirm, onReset }: ReviewActionsProps) {
  return (
    <>
